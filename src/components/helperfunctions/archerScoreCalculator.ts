export function calculateArcherScore(formValues: any) {
  ...
  let equipmentScoreChart = {
    ...
    kvk_helmet: [
      15 * attackMultiplier,
      15 * attackMultiplier + 10,
      15 * attackMultiplier + 10 + 1.5 * healthMultiplier,
      15 * attackMultiplier + 10 + 1.5 * healthMultiplier,
      15 * attackMultiplier +
        10 +
    ...
    dragon_chest: [
      ...
      11 * healthMultiplier + 10 + 1 * defenseMultiplier,
      11 * healthMultiplier + 10 + 1 * defenseMultiplier,
      11 * healthMultiplier +
        10 +
        1 * defenseMultiplier +
    ...
    milky_way_chest: [
      ...
      12 * healthMultiplier + 10 + 1 * defenseMultiplier,
      12 * healthMultiplier + 10 + 1 * defenseMultiplier,
      12 * healthMultiplier +
        10 +
        1 * defenseMultiplier +
    ...
    dragon_gloves: [
      7.5 * attackMultiplier,
      7.5 * attackMultiplier + 10,
      7.5 * attackMultiplier + 10 + 1 * attackMultiplier,
      7.5 * attackMultiplier + 10 + 1 * attackMultiplier,
      7.5 * attackMultiplier + 10 + 1 * attackMultiplier,
      7.5 * attackMultiplier + 10 + 1 * attackMultiplier,
    ],
    leadership_gloves: [
      6 * defenseMultiplier,
      6 * defenseMultiplier + 10,
      6 * defenseMultiplier + 10 + 1 * attackMultiplier,
      6 * defenseMultiplier + 10 + 1 * attackMultiplier,
      6 * defenseMultiplier + 10 + 1 * attackMultiplier,
      6 * defenseMultiplier + 10 + 1 * attackMultiplier,
    ],
    ...
    dragon_boots: [
      ...
      7.5 * defenseMultiplier + 10 + 1 * attackMultiplier,
      7.5 * defenseMultiplier + 10 + 1 * attackMultiplier,
      7.5 * defenseMultiplier + 10 + 1 * attackMultiplier,
      7.5 * defenseMultiplier + 10 + 1 * attackMultiplier,
    ],
    leadership_boots: [
      6 * healthMultiplier,
      6 * healthMultiplier + 10,
      6 * healthMultiplier + 10 + 1 * attackMultiplier,
      6 * healthMultiplier + 10 + 1 * attackMultiplier,
      6 * healthMultiplier + 10 + 1 * attackMultiplier,
      6 * healthMultiplier + 10 + 1 * attackMultiplier,
    ],
    ...
    leadership_legs: [
      ...
      8 * healthMultiplier + 10 + 1 * healthMultiplier,
      8 * healthMultiplier + 10 + 1 * healthMultiplier,
      8 * healthMultiplier +
        10 +
        1 * healthMultiplier +
    ...
    kvk_weapon: [
      ...
      25 * attackMultiplier + 10 + 2.5 * defenseMultiplier,
      25 * attackMultiplier + 10 + 2.5 * defenseMultiplier,
      25 * attackMultiplier +
        10 +
  ...
  if (chest === "archer-chest-epic") {
    equipmentScore +=
      ...
      chestMultiplier;
  } else if (chest === "dragon-breath-legendary") {
    equipmentScore +=
      equipmentScoreChart["dragon_chest"][Number(equipment["chestIconic"])] *
      chestMultiplier;
  } else if (chest === "milky-way-legendary") {
    equipmentScore +=
      equipmentScoreChart["milky_way_chest"][Number(equipment["chestIconic"])] *
      chestMultiplier;
  }
  ...
  if (gloves === "archer-gloves-epic") {
    equipmentScore +=
      ...
      glovesMultiplier;
  } else if (gloves === "dragon-breath-legendary") {
    equipmentScore +=
      equipmentScoreChart["dragon_gloves"][Number(equipment["glovesIconic"])] *
      glovesMultiplier;
  } else if (gloves === "leadership-legendary") {
    equipmentScore +=
      equipmentScoreChart["leadership_gloves"][
        Number(equipment["glovesIconic"])
      ] * glovesMultiplier;
  }
  ...
  if (legs === "archer-legs-epic") {
    equipmentScore +=
      ...
      legsMultiplier;
  } else if (legs === "dragon-breath-legendary") {
    equipmentScore +=
      equipmentScoreChart["dragon_legs"][Number(equipment["legsIconic"])] *
      legsMultiplier;
  } else if (legs === "leadership-legendary") {
    equipmentScore +=
      equipmentScoreChart["leadership_legs"][Number(equipment["legsIconic"])] *
      legsMultiplier;
  }
  ...
  if (boots === "infantry-boots-epic") {
    equipmentScore +=
      ...
      bootsMultiplier;
  } else if (boots === "dragon-breath-legendary") {
    equipmentScore +=
      equipmentScoreChart["dragon_boots"][Number(equipment["bootsIconic"])] *
      bootsMultiplier;
  } else if (boots === "leadership-legendary") {
    equipmentScore +=
      equipmentScoreChart["leadership_boots"][
        Number(equipment["bootsIconic"])
      ] * bootsMultiplier;
  }
