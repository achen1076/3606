...
export default function InfLeadForm() {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    const archerAttackInput = form.querySelector(
      'input[name="archerAttack"]'
    ) as HTMLInputElement;
    const archerDefenseInput = form.querySelector(
      'input[name="archerDefense"]'
    ) as HTMLInputElement;
    const archerHealthInput = form.querySelector(
      'input[name="archerHealth"]'
    ) as HTMLInputElement;
    ...
    const formValues = {
      ...
      armaments: {
        archerAttack: archerAttackInput?.value
          ? parseFloat(archerAttackInput.value)
          : 0,
        archerDefense: archerDefenseInput?.value
          ? parseFloat(archerDefenseInput.value)
          : 0,
        archerHealth: archerHealthInput?.value
          ? parseFloat(archerHealthInput.value)
          : 0,
      ...
      <form className="space-y-8" onSubmit={handleSubmit}>
        ...
        <div className="pb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-gray-300 mb-2">Archer Defense</label>
              <input
                type="number"
                name="archerDefense"
                placeholder="Archer Defense %"
                step="0.1"
                className="w-full bg-gray-800 border border-gray-700 rounded-md px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-rok-purple focus:border-transparent transition-all duration-200"
                required
              />
            ...
            <div>
              <label className="block text-gray-300 mb-2">Archer Health</label>
              <input
                type="number"
                name="archerHealth"
                placeholder="Archer Health %"
                step="0.1"
                className="w-full bg-gray-800 border border-gray-700 rounded-md px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-rok-purple focus:border-transparent transition-all duration-200"
                required
              />
